...
G3World.initProjection = function(width, height, near, far, fov, aspect) {
    var c = g3w.c;
    ...
    g3w.viewport.aspect = aspect = width / height;

    var pMatrix = mat4.create();
    mat4.perspective(fov, aspect, near, far, pMatrix);
...
G3World.renderObjects = function(program, camRotation) {
    G3World.setUniforms({"uCamMatrix": G3World.mv.current,
                         ...
                         "aspectRatio": g3w.viewport.aspect,
                         "uFogStart": 80.0,
                         "uFogEnd": 100.0,
